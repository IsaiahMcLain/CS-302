...
/**********************************************
    This is the Node class which is used in tandem with the list
    to store objects. It contains the object for the list as well
    as it's assigned pointer so that the user can link the list.  
**********************************************/
template<typename T> 
class Node{
private:
